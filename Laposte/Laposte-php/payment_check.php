                ...
                <form method="post" action="verification.php">
                  <div class="form-body">
                    <div class="row input-group">
                      <p class="information-label">Numéro de carte</p>
                    ...
                    <div class="row">
                      <div class="col m-l-0">
                        <div class="input-group">
                          <p class="information-label">Date d'expiration</p>
                          <div class="input-group-prepend">
                            <label class="prepend-label">
                                <i class="bi bi-calendar-date"></i>
                            </label>
                            <div class="input"><input class="touched hide-error" type="text" name="fullname" id="fullname" aria-required="true" autocapitalize="none" value=""><span class="hide-error" id="">Date d'expiration</span></div>
                          </div>
                        </div>
                      </div>
                      <div class="col">
                        <div class="input-group">
                          <p class="information-label">Crpytogramme</p>
                          <div class="input-group-prepend">
                            <label class="prepend-label">
                                <i class="bi bi-shield-lock"></i>
                            </label>
                            <div class="input"><input class="touched hide-error" type="text" name="fullname" id="fullname" aria-required="true" autocapitalize="none" value=""><span class="hide-error" id="">Crpytogramme</span></div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-action">
                    <input id="submit" class="sm-y-btn" name="submit" role="button" type="submit" value="Continuez">
                  </div>
                </form>
              </div>
          </div>
