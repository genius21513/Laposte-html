    ...
    <div class="site">
      <div id="page">
        <section class="page-container">
          ...
          <div class="in-panel mt-3">
            <h2 class="information-label-title">Votre adresse de colis a été mise à jour.</h1>
            <h6 class="information-label">
              Nous relivrons votre colis dès que possible. <br/>
              Puis le reste est identique à ce diagramme, totalement inchangé
            </h6>
                ...
                <div class="form-body">
                  <div class="d-flex justify-content-between">
                    <div class="icon-group">
                      <img class="detail-icon" src="./assets/images/laposte-icon.webp" width="50" height="50" class="section-market-cat-img" alt="" >
                      <span class="detail-title"> La Poste</span>
                    </div>
                    <span class="detail-value">1 article</span>
                  </div>
                  <div class="card res-card">
                    <h2 class="title" style="color: #2b6eb4;">Commande n° 1153339836  
                    <i class="bi bi-check2-circle text-success"></i>
                    </h2>
                    <div class="w-100 d-flex justify-content-between">
                      <h5>Total HT : 1.9€ </h5> 
                      <h5>Télécharger la facture en PDF </h5>
                    </div>
                  </div>
                </div>
                <div class="form-action">
                  <input id="submit" name="submit" role="button"
                  type="submit" value="Retour sur l’accueil de la boutique!">
                </div>
              </form>
            </div>
          </div>
